...
require "map_gen.scrapyard.flamethrower_nerf"
require "features.modules.rocks_yield_ore_veins"
...
require "features.modules.explosives"
require "features.modules.wave_defense.main"
...
local Reset = require "features.functions.soft_reset"
...
local Loot = require 'map_gen.scrapyard.loot'
local Pets = require "features.modules.biter_pets"
local Modifier = require "utils.player_modifiers"
local tick_tack_trap = require "features.functions.tick_tack_trap"
local Terrain = require 'map_gen.scrapyard.terrain'
local Event = require 'utils.event'
local math_random = math.random

local Locomotive = require "map_gen.scrapyard.locomotive".locomotive_spawn
...
local function on_tick()
	...
	if game.tick == 100 then
		Terrain.reveal_area(0, -3, surface, 23)
		Terrain.reveal_area(20, -3, surface, 23)
		Terrain.reveal_area(-20, -3, surface, 23)
	end
end
